...
begin
  LimparCampos;
  vTitulo := InputBox('Título', 'Digite um título para seu jogo!', '');
  TratarTitulo;
...
begin
  ...
  case vNumero of
    ...
    2: vFrase := 'Só um patinho na lagoa';
    3: vFrase := 'O numero dos porquinhos';
    4: vFrase := 'Pernas da mesa';
    5: vFrase := 'Cachorro';
    6: vFrase := 'Pingo na pança, o 6 que avança. numero';
    7: vFrase := 'Anões da branca de neve';
    8: vFrase := 'Biscoito';
    9: vFrase := 'Pingo no pé nove é';
    10: vFrase := '*Raso* Craque de bola';
    11: vFrase := 'Casa de bronze, numero';
    12: vFrase := 'Uma duzia';
    13: vFrase := 'Número do azar';
    15: vFrase := 'Menina moça';
  ...
  begin
    pnlNumeroSorteado.Caption := 'O número sorteado é: ' + IntToStr(vNumero);
  end;
  ...
  lblSorteados.Caption := 'Total de números sorteados: ' + IntToStr(CDS_Sorteados.RecordCount) + '       ';
